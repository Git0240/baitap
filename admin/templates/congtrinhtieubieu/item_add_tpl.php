...
<form name="frm" method="post" action="index.php?com=congtrinhtieubieu&act=save" enctype="multipart/form-data" class="nhaplieu">
...
<!--    end menu doc-->
 ...
 <br>
  ...
  <br>
    ...
    <input type="button" value="Thoát" onclick="javascript:window.location = 'index.php?com=congtrinhtieubieu&act=man'" class="btn" />
</form>