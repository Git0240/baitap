...
<form name="frm" method="post" action="index.php?com=news&act=save" enctype="multipart/form-data" class="nhaplieu">
...
<br />
   <?php if (@$_REQUEST['act']=='edit')
	...
	<b>Tiêu đề Chinese</b> <input type="text" name="ten_cn" value="<?=@$item['ten_cn']?>" class="input" /><br />
	...
	<b>Mô tả (Chinese)</b>
	<div><textarea name="mota_cn" cols="50" rows="3" id="mota_en"><?=@$item['mota_cn']?></textarea></div>
	...
	<b>Nội dung (Chinese)</b>
	<div>
	<?php
	$oFCKeditor = new FCKeditor('noidung_cn') ;
	$oFCKeditor->BasePath	= $sBasePath ;
	$oFCKeditor->Height		= 300;
	$oFCKeditor->Value		= @$item['noidung_cn'];
	$oFCKeditor->Create() ;
	?>
	</div>
