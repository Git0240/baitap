...
<h3><a href="index.php?com=hotline&amp;act=add">Thêm mới</a></h3>
...
<table class="blue_table">
    ...
    <?php for ($i = 0, $count = count($items); $i < $count; $i++) { ?>
        <tr>
            ...
            <td style="width:6%;"><a href="index.php?com=hotline&act=delete&id=<?=$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" /></a></td>
        </tr>
<?php } ?>
</table>
