...
<form name="frm" method="post" action="index.php?com=htpg&act=save" enctype="multipart/form-data" class="nhaplieu">
    <b>Tên: </b>
   ...
   <br/>
    ...
    <input type="button" value="Thoát" onclick="javascript:window.location = 'index.php?com=htpg&act=man'" class="btn" />
</form>